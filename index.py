	...
	def handle(self, handler_input):
		...
		if not attr:
			...
			if missionDeadline.days >= 1:
				speechText = "<say-as interpret-as=\"interjection\">Hey Exploradores!</say-as>, ¿Habéis encontrado los objetos?. Si no los recuerdas son estos: {}".format(", ".join(attr["objsToSearch"]))
